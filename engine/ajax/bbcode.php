...
$code = <<<HTML
<div style="width:99%; height:50px; border:1px solid #BBB; background-image:url('{THEME}/bbcodes/bg.gif');">
...
<div class="editor_button" onclick="tag_pdf()"><img src="{THEME}/bbcodes/pdf.gif" align="center" width="23" height="25" border="0" alt="" /></div>
...
HTML;
   ...
   {
      $url_link = "<div class=\"editor_button\"  onclick=\"tag_url()\"><img title=\"$lang[bb_t_url]\" src=\"{THEME}/bbcodes/link.gif\" width=\"23\" height=\"25\" border=\"0\"></div><div class=\"editor_button\"  onclick=\"tag_leech()\"><img title=\"$lang[bb_t_leech]\" src=\"{THEME}/bbcodes/leech.gif\" width=\"23\" height=\"25\" border=\"0\"></div>";
   } 
   else {$url_link = "";}

   if ($user_group[$member_id['user_group']]['allow_image'])
   {
      $image_link = "<div class=\"editor_button\" onclick=tag_image()><img title=\"$lang[bb_b_img]\" src=\"{THEME}/bbcodes/image.gif\" width=\"23\" height=\"25\" border=\"0\"></div>";
   } 
   else $image_link = "";
...
var text_enter_sizepdf       = "$lang[bb_pdf]";
var text_enter_pdf       = "$lang[bb_pdf_url]"
