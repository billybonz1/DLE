...
var text_enter_sizepdf       = "$lang[bb_flash]";
var text_enter_pdf       = "$lang[bb_flash_url]";
...
function tag_pdf()
{
	...
	DLEprompt(text_enter_pdf, thesel, dle_prompt, function (r) {

		var enterURL = r;

		DLEprompt(text_enter_sizepdf, "425,264", dle_prompt, function (r) {

			doInsert("[pdf="+r+"]"+enterURL+"[/pdf]", "", false);
			ie_range_cache = null;
...
function tag_image()
{
	...
	DLEprompt(text_enter_image, thesel, dle_prompt, function (r) {
		...
		DLEprompt(img_title, "{$config['image_align']}", dle_prompt, function (r) {
...
window.open('?mod=files&action=quick&area=' + selField + '&author={$p_name}&news_id={$id}', '_Addimage', 'toolbar=0,location=0,status=0, left=0, top=0, menubar=0,scrollbars=yes,resizable=0,width=640,height=550');    
...
<div class="editor_button"><img src="engine/skins/bbcodes/images/brkspace.gif" width="5" height="25" border="0"></div>
<div id="b_color" class="editor_button" onclick="ins_color(this);"><img src="engine/skins/bbcodes/images/color.gif" width="23" height="25" border="0"></div>
...
<div id="b_pdf" class="editor_button" onclick="tag_pdf()"><img src="engine/skins/bbcodes/images/pdf.gif" width="23" height="25" border="0"></div>
...
{$typograf}
<div class="editor_button"><img src="engine/skins/bbcodes/images/brkspace.gif" width="5" height="25" border="0"></div>
<div id="b_list" class="editor_button" onclick="tag_list('list')"><img src="engine/skins/bbcodes/images/list.gif" width="23" height="25" border="0"></div>
