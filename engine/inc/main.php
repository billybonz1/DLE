...
HTML;
	echo "<br /><input id=\"check_updates\" name=\"check_updates\" class=\"edit\" style=\"width:220px;\" type=\"button\" value=\"{$lang['dle_udate']}\">&nbsp;<input id=\"clearbutton\" name=\"clearbutton\" class=\"edit\" style=\"width:150px;\" type=\"button\" value=\"{$lang['btn_clearcache']}\">";

	if ($count_subscribe) echo "&nbsp;<input id=\"clearsubscribe\" name=\"clearsubscribe\" class=\"edit\" style=\"width:300px;\" type=\"button\" value=\"{$lang['btn_clearsubscribe']}\">";
...
HTML;
		echo "<br /><table width=\"100%\"align=center><tr><td style='padding:3px; border:1px dashed rgb(190,190,190); background-color:lightyellow;'>
         <div id=\"dle-activation\">$lang[trial_info]<br /><br /><b>$lang[trial_key]</b><span style=\"padding-left:7px;\"><input class=\"edit bk\" type=\"text\" size=\"45\" name=\"sitekey\" id=\"sitekey\"> <input class=\"edit\" type=\"button\" onClick=\"dle_activation( 'key' ); return false;\" value=\"$lang[trial_act]\"></span><div id=\"result_info\" style=\"color:red;\"><br /><span class=\"navigation\">{$lang['key_format']} <b>XXXXX-XXXXX-XXXXX-XXXXX-XXXXX</b></span></div></div>
	...
	if( !file_exists( ROOT_DIR .'/uploads/.htaccess' ) ) {
		echo "<br><table width=\"100%\" align=center><tr><td>
       <div class=\"ui-state-error ui-corner-all\" style=\"padding:10px;\">".str_replace("{folder}", "/uploads/", $lang['stat_secfault_2'])."</div>
          </td></tr><tr><td>&nbsp;</td></tr></table>";
	}

	if( !file_exists( ROOT_DIR .'/templates/.htaccess' ) ) {
		echo "<br><table width=\"100%\" align=center><tr><td>
       <div class=\"ui-state-error ui-corner-all\" style=\"padding:10px;\">".str_replace("{folder}", "/templates/", $lang['stat_secfault_2'])."</div>
          </td></tr><tr><td>&nbsp;</td></tr></table>";
	}
