...
if( !$user_group[$member_id['user_group']]['admin_googlemap'] || $member_id['user_group'] != 1) {
...
HTML;
	...
	if(!@file_exists(ROOT_DIR. "/uploads/sitemap.xml")){ 
		...
		echo "<br /><br /><input id=\"sendbutton\" name=\"sendbutton\" type=\"button\" class=\"buttons\" value=\"{$lang['google_map_send']}\" style=\"width:450px;\" /><br /><br /><div id=\"send_result\"></div>";
