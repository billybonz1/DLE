...
if( $action == "save" ) {
	...
	$new_pm_text = preg_replace( $find, $replace, $db->safesql( $_POST['new_pm_text'] ) );
...
<table width="100%">
    ...
    <tr>
        <td style="padding:2px;"><textarea rows="15" style="width:650px;" name="reg_mail_text" class="bk">{$reg_mail}</textarea></td>
    </tr>
</table>
<table width="100%">
    <tr>
...
<table width="100%">
    ...
    <tr>
        <td style="padding:2px;"><textarea rows="15" style="width:650px;" name="feed_mail_text" class="bk">{$feed_mail}</textarea></td>
    </tr>
</table>
<table width="100%">
    <tr>
...
<table width="100%">
    ...
    <tr>
        <td style="padding:2px;"><textarea rows="15" style="width:650px;" name="lost_mail_text" class="bk">{$lost_mail}</textarea>
</td>
    </tr>
</table>
...
<table width="100%">
    ...
    <tr>
        <td style="padding:2px;"><textarea rows="15" style="width:650px;" name="new_news_text" class="bk">{$new_news}</textarea>
</td>
    </tr>
</table>
...
<table width="100%">
    ...
    <tr>
        <td style="padding:2px;"><textarea rows="15" style="width:650px;" name="new_comments_text" class="bk">{$comments}</textarea>
</td>
    </tr>
</table>
...
<table width="100%">
    ...
    <tr>
        <td style="padding:2px;"><textarea rows="15" style="width:650px;" name="new_pm_text" class="bk">{$pm}</textarea>
