...
<table width="100%">
    <tr>
        <td style="padding:2px;" height="70">{$lang['opt_iptoolsc']}<br /><input class="edit bk" style="width:250px;" type="text" name="ip" value="{$ip}">&nbsp;&nbsp;&nbsp;<input type="submit" value="{$lang['b_find']}" class="edit"><br /><span class=small>{$lang['opt_ipfe']}</span></td>
    </tr>
    <tr>
        <td style="padding:2px;"><div class="hr_line"></div></td>
    </tr>
    <tr>
        <td style="padding:2px;" height="70">{$lang['opt_iptoolsname']}<br /><input class="edit bk" style="width:250px;" type="text" name="name" value="{$name}">&nbsp;&nbsp;&nbsp;<input type="submit" value="{$lang['b_find']}" class="edit"></td>
    </tr>
</table>
</td>
