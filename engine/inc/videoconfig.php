...
HTML;
	...
	showRow( $lang['vconf_bcbarcolor'], $lang['vconf_bcbarcolord'], "<input class=\"edit bk\" type=text style=\"text-align: center;\" name=\"save_con[backgroundBarColor]\" value=\"{$video_config['backgroundBarColor']}\" size=20>" );
	showRow( $lang['vconf_btnscolor'], $lang['vconf_btnscolord'], "<input class=\"edit bk\" type=text style=\"text-align: center;\" name=\"save_con[btnsColor]\" value=\"{$video_config['btnsColor']}\" size=20>" );
	showRow( $lang['vconf_outtxtcolor'], $lang['vconf_outtxtcolord'], "<input class=\"edit bk\" type=text style=\"text-align: center;\" name=\"save_con[outputTxtColor]\" value=\"{$video_config['outputTxtColor']}\" size=20>" );
	showRow( $lang['vconf_outbkgbolor'], $lang['vconf_outbkgbolord'], "<input class=\"edit bk\" type=text style=\"text-align: center;\" name=\"save_con[outputBkgColor]\" value=\"{$video_config['outputBkgColor']}\" size=20>" );

	showRow( $lang['vconf_lbarbolor'], $lang['vconf_lbarbolord'], "<input class=\"edit bk\" type=text style=\"text-align: center;\" name=\"save_con[loadingBarColor]\" value=\"{$video_config['loadingBarColor']}\" size=20>" );
	showRow( $lang['vconf_lbckbolor'], $lang['vconf_lbckbolord'], "<input class=\"edit bk\" type=text style=\"text-align: center;\" name=\"save_con[loadingBackgroundColor]\" value=\"{$video_config['loadingBackgroundColor']}\" size=20>" );
	...
	showRow( $lang['vconf_vstbarbolor'], $lang['vconf_vstbarbolord'], "<input class=\"edit bk\" type=text style=\"text-align: center;\" name=\"save_con[volumeStatusBarColor]\" value=\"{$video_config['volumeStatusBarColor']}\" size=20>" );
	showRow( $lang['vconf_vbckbolor'], $lang['vconf_vbckbolord'], "<input class=\"edit bk\" type=text style=\"text-align: center;\" name=\"save_con[volumeBackgroundColor]\" value=\"{$video_config['volumeBackgroundColor']}\" size=20>" );
...
echo <<<HTML
    ...
    <input type="hidden" name="user_hash" value="$dle_login_hash" /><input type="submit" class="buttons" value="&nbsp;&nbsp;{$lang['user_save']}&nbsp;&nbsp;">{$fail}</td>
    </tr>
</table>
</td>
        <td background="engine/skins/images/tl_rb.gif"><img src="engine/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
