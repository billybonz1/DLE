...
<table width="100%">
  <tr>
   ...
   <td width=80 align="center">{$lang[vote_action]}</td>
	...
	{$entries}
	<tr><td colspan="5"><div class="hr_line"></div></td></tr>
  <tr><td colspan="5">{$offline}<a href="?mod=rssinform&action=add"><input onclick="document.location='?mod=rssinform&action=add'" type="button" class="buttons" value="&nbsp;&nbsp;{$lang['rssinform_create']}&nbsp;&nbsp;"></a></td></tr>
</table>
