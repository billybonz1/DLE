...
<table width="100%">
    <tr>
        ...
        <td><input class=edit style="width: 312px;" type="text" name="editedxfield[0]" value="<? echo $editedxfield[0];?>" />&nbsp;&nbsp;&nbsp;(<?php echo $lang['xf_lat']; ?>)</td>
    </tr>
    <tr>
        <td style="padding:4px;"><?php echo $lang['xfield_xdescr']; ?></td>
        <td><input  class=edit style="width: 312px;" type="text" name="editedxfield[1]" value="<? echo $editedxfield[1];?>" /></td>
    </tr>
<?php
...
case "list":
    ...
    foreach ($xfields as $name => $value) {
      ...
      if ($value[3] == "textarea") {      
		if ($bb_editor) $params = "onclick=\"setFieldName(this.id)\" "; else $params = "class=\"mceEditor\" ";
