...
<table width="100%">
    <tr>
        ...
        <td background="engine/skins/images/tl_rb.gif"><img src="{$theme}/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
    </tr>
    <tr>
...
<table width="100%">
    <tr>
<td bgcolor="#EFEFEF" height="40" align="center" style="padding-right:10px;"><div class="navigation"><a href="http://dle-news.ru/" target="_blank">DataLife Engine</a><br />Copyright 2010 &copy; <a href="http://dle-news.ru/" target="_blank">SoftNews Media Group</a>. All rights reserved.</div></td>
    </tr>
</table></div>		
		</td>
...
$login_panel = <<<HTML
<form  name="login" action="{$PHP_SELF}" method="post"><input type="hidden" name="action" value="dologin">
<div style="padding-top:5px;">
<table width="100%">
    <tr>
        <td width="4"><img src="{$theme}/skins/images/tl_lo.gif" width="4" height="4" border="0"></td>
...
<table width="100%">
    <tr>
        <td bgcolor="#EFEFEF" height="29" style="padding-left:10px;"><div class="navigation">Для того чтобы продолжить процесс обновления скрипта, вам необходимо ввести имя и пароль администратора</div></td>
    </tr>
</table>
<div class="unterline"></div>
<table width="100%">
    <tr>
        <td width="55" style="padding:5px;" rowspan="2"><img src="{$theme}/skins/images/key.png" border="0"></td>
    ...
    <tr>
        ...
        <td><input class="edit" type="password" name="password" size="20">&nbsp;&nbsp;<input type="submit" class="edit" value="Вход"></td>
    </tr>
</table>
<div class="hr_line"></div>
<div class="navigation">Внимание после корректного ввода логина и пароля начнетcя процесс обновления базы данных скрипта. Этот процесс может занять довольно продолжительное время, поэтому <font color="red">обязательно дождитесь</font> завершения работы и соответствующего уведомления.</div>
</td>
        <td background="{$theme}/skins/images/tl_rb.gif"><img src="{$theme}/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
    </tr>
    <tr>
