...
if(node._hc == false) {lk=node.url;} else {lk='javascript: ' + this.obj + '.o(' + nodeId + ');';}

		str += '<a id="s' + this.obj + nodeId + '" class="' + ((this.config.useSelection) ? ((node._is ? 'nodeSel' : 'node')) : 'node') + '"  href="' + lk + '"';
